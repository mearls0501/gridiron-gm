...
const FAST: Step[] = [
  ...
  { name: "tradewindow", cmd: "npx", args: ["tsx", "lib/view/tradeWindow.test.ts"], exitGates: true },
  { name: "rostercap",    cmd: "npx", args: ["tsx", "lib/view/rosterCap.test.ts"],  exitGates: true },
  { name: "teamleaders",  cmd: "npx", args: ["tsx", "lib/view/teamLeaders.test.ts"], exitGates: true },
  { name: "playbyplay",   cmd: "npx", args: ["tsx", "lib/view/playByPlay.test.ts"], exitGates: true },
  { name: "irps",         cmd: "npx", args: ["tsx", "lib/core/rosterStatus.test.ts"], exitGates: true },
  { name: "inactives",    cmd: "npx", args: ["tsx", "lib/core/inactives.test.ts"], exitGates: true },
  { name: "waivers",      cmd: "npx", args: ["tsx", "lib/core/waivers.test.ts"], exitGates: true },
  { name: "callsheet",    cmd: "npx", args: ["tsx", "lib/core/callSheet.test.ts"], exitGates: true },
  { name: "livegame",     cmd: "npx", args: ["tsx", "lib/core/liveGame.test.ts"], exitGates: true },
  { name: "franchisetag", cmd: "npx", args: ["tsx", "lib/core/franchiseTag.test.ts"], exitGates: true },
  { name: "fifthyearoption", cmd: "npx", args: ["tsx", "lib/core/fifthYearOption.test.ts"], exitGates: true },
  { name: "tagextension", cmd: "npx", args: ["tsx", "lib/core/tagExtension.test.ts"], exitGates: true },
  { name: "halloffame",   cmd: "npx", args: ["tsx", "lib/core/hallOfFame.test.ts"], exitGates: true },
  { name: "hofinduction", cmd: "npx", args: ["tsx", "lib/core/hofInduction.test.ts"], exitGates: true },
  { name: "jersey",       cmd: "npx", args: ["tsx", "lib/core/jersey.test.ts"], exitGates: true },
  { name: "contractoffice", cmd: "npx", args: ["tsx", "lib/core/contractOffice.test.ts"], exitGates: true },
  { name: "capmechanics", cmd: "npx", args: ["tsx", "lib/core/capMechanics.test.ts"], exitGates: true },
  { name: "contractceiling", cmd: "npx", args: ["tsx", "lib/core/contractCeiling.test.ts"], exitGates: true },
  { name: "draftrules", cmd: "npx", args: ["tsx", "lib/core/draftRules.test.ts"], exitGates: true },
  { name: "peoplecheck", cmd: "npx", args: ["tsx", "lib/core/coaches.test.ts"], exitGates: true },
  { name: "ownercheck",  cmd: "npx", args: ["tsx", "lib/core/owner.test.ts"],   exitGates: true },
  { name: "psychology",  cmd: "npx", args: ["tsx", "lib/core/psychology.test.ts"], exitGates: true },
  { name: "secondscene", cmd: "npx", args: ["tsx", "lib/core/secondScene.test.ts"], exitGates: true },
  { name: "peopleteeth", cmd: "npx", args: ["tsx", "lib/core/peopleTeeth.test.ts"], exitGates: true },
  { name: "housekeeping", cmd: "npx", args: ["tsx", "lib/core/housekeeping.test.ts"], exitGates: true },
  { name: "wave25bugs", cmd: "npx", args: ["tsx", "lib/core/wave25Bugs.test.ts"], exitGates: true },
  { name: "injuries",    cmd: "npx", args: ["tsx", "lib/core/season/injuries.test.ts"], exitGates: true },
