...
| ~~`drift.saveGrowthMbPerSeason` — false P0 from a threshold conflict~~ **RESOLVED 2026-08-03; RE-LOCKED 2026-09-13 (Wave 3.7 Packet 2, Matt SIGNED).** Mac Studio 5-seed panel at `2752729` (#77) read **0.47**; signed max is **0.52** (panel + 0.05). `saveMbAtEnd` signed max **13.1** (panel 12.10 + 1.0 MB). Reason: PS/IR/waiver/camp-90 bodies plus Wave 1/2 fields on the encoded save (`nfl-reference.md` §6.9). **20 MB quota unchanged.** | +0.47 MB ✓ | < 0.52 |
