...
- **Training-camp roster cap (90).** Added 2026-09-02. Not in T/D/S/P. The
  ...
  extras below that line do not fill the need. The filter applies in camp
  (draft / cutdown) or whenever the club holds more than 53; the locked
  53-man in-season headcount is unchanged.
